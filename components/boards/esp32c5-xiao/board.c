...
/**
 * @file board.c
 * @brief Seeed XIAO ESP32-C5 board implementation
 *
 * Minimal implementation for the Seeed Studio XIAO ESP32-C5 with an external
 * I2S DAC. No board-specific initialization required.
 */
...
static const char TAG[] = "XIAO-ESP32C5";
